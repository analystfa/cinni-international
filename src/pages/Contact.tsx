            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="https://wa.me/917080500444" target="_blank" rel="noopener noreferrer" className="font-body text-sm text-muted-foreground hover:text-primary transition-colors">+91 7084 500 555</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
